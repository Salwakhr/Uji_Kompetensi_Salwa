...
if(isset($_POST['btn-simpan'])){   
    ...
    $diskon = $_POST['diskon'];
    $pajak = $_POST['pajak'];
    $outletasu = $outlet_id['outlet_id'];
    
    $query = "INSERT INTO transaksi (outlet_id,kode_invoice,member_id,tgl,batas_waktu,biaya_tambahan,diskon,pajak,status,status_bayar,user_id) VALUES ('$outletasu','$kode_invoice','$member_id','$tgl_sekarang','$batas_waktu','$biaya_tambahan','$diskon','$pajak','baru','belum','$user_id')";
